...
const cardData: BentoCardProps[] = [
  {
    ...
    description: 'Follow-ups that actually follow up',
    label: 'Memory'
  },
  {
    color: '#120F17',
    title: 'Task execution',
    description: 'Books, sends, schedules, confirms',
    label: 'Action'
  },
  {
    color: '#120F17',
    title: 'On-device speed',
    description: 'Fast when you are on the move',
    label: 'Local'
  },
  {
    color: '#120F17',
    title: 'App integrations',
    description: 'Mail, maps, calendar, messages',
    label: 'Connect'
  },
  {
    color: '#120F17',
    title: 'Voice + text',
    description: 'Talk naturally, edit in text',
    label: 'Input'
  },
  {
    color: '#120F17',
    title: 'You approve sends',
    description: 'Nothing ships without a yes',
    label: 'Trust'
  }
];
